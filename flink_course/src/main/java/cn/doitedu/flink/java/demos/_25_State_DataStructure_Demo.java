        ...
        source
                ...
                .map(new RichMapFunction<String, String>() {
                    ...
                    public void open(Configuration parameters) {
                        ...
                        // 获取一个 单值 结构的状态存储器
                        valueState = runtimeContext.getState(new ValueStateDescriptor<>("vstate", String.class));
                        // 获取一个List结构的状态存储器
                        lstState = runtimeContext.getListState(new ListStateDescriptor<>("lst", String.class));
                        // 获取一个 Map 结构的状态存储器
                        mapState = runtimeContext.getMapState(new MapStateDescriptor<>("xx", String.class, String.class));
                        // 获取一个reduce聚合状态
                        reduceState = runtimeContext.getReducingState(new ReducingStateDescriptor<>("reduceState", new ReduceFunction<Integer>() {
                            @Override
                        ...
                        // 获取一个aggregate聚合状态
                        // 比如，我们要插入整数，返回平均值
                        aggState = runtimeContext.getAggregatingState(new AggregatingStateDescriptor<>("aggState", new AggregateFunction<Integer, Tuple2<Integer, Integer>, Double>() {
                            @Override
