        ...
        SinkFunction<EventLog> exactlyOnceSink = JdbcSink.exactlyOnceSink(
                ...
                new SerializableSupplier<XADataSource>() {
                    ...
                    public XADataSource get() {
                        // XADataSource就是jdbc连接，不过它是支持分布式事务的连接, 而且它的构造方法对于不同的数据库构造方法不同
                        MysqlXADataSource xaDataSource = new MysqlXADataSource();
                        xaDataSource.setUrl("jdbc:mysql://master102:3306/abc?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=UTF-8");
