...
public class _07_Transformation_Demos {
    public static void main(String[] args) throws Exception {
         ...
         * 并统计：
         *    各性别用户的好友总数
         *    各性别中，用户好友数量最大值,用户好友数量最小值, 好友数量最大的那个人,好友数量最小的那个人
         *
         */
        // 各性别用户的好友总数
        ...
        // 各性别中，用户好友数量最大值
        /*
         * max / maxBy  都是滚动聚合：算子不会把收到的所有数据全部攒起来；而是只在状态中记录上一次的聚合值，然后当新数据到达的时候，会根据逻辑去更新状态中记录的聚合值，并输出最新状态数据
         * max / maxBy  区别： 更新状态的逻辑！max只更新要求最大值的字段；而maxBy 会更新整条数据；
         * 同理，min和minBy也如此
         */
        ...
        /*
         * reduce 算子 使用演示
         * 需求： 求各性别中，好友数量最大的那个人，而且如果前后两个人的好友数量相同，则输出的结果中也需要将uid/name等信息更新成后面一条数据的值
         */
        SingleOutputStreamOperator<Tuple4<Integer, String, String, Integer>> reduceResult = tuple4Stream.keyBy(tp -> tp.f2)
                .reduce(new ReduceFunction<Tuple4<Integer, String, String, Integer>>() {
                     ...
                     */
                    @Override
                    public Tuple4<Integer, String, String, Integer> reduce(Tuple4<Integer, String, String, Integer> value1, Tuple4<Integer, String, String, Integer> value2) {
