...
public class _04_WordCount_LambdaTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 先把句子变大写
        /* 从map算子接收的MapFunction接口实现来看, 它是一个单抽象方法的接口, 所以这个接口的实现类的核心功能，就在它的方法上
        那就可以用lambda表达式来简洁实现
        ...
        // 从上面的接口来看，它依然是一个单抽象方法的接口，所以它的方法实现，依然可以用lambda表达式来实现
        ...
        // 从上面的KeySelector接口来看，它依然是一个单抽象方法的接口，所以它的方法实现依然可以用lambda表达式来实现
