...
public class _27_ToleranceConfig_Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // checkpoint相关配置
        // 传入两个最基本ck参数：间隔时长指的是每隔多久往数据里插入标记，ck模式指得是对齐模式还是非对齐的ck
        ...
        //设置两次ck进行快照之间的最小时间间隔，用于防止checkpoint过多地占用算子的处理时间
        ...
        // 允许的checkpoint失败最大次数(失败指的是一定时间间隔内仍然无法达到所有算子已经响应ck完成的状态)
        ...
        // 固定延迟重启（参数 1： 故障重启最大次数；参数2： 两次重启之间的延迟间隔）
