...
public class _08_SinkOperator_Demos {
    public static void main(String[] args) throws Exception {
        ...
        /*
         * 2. 输出为 列格式
         * 要构造一个列模式的 FileSink，需要一个ParquetAvroWriterFactory, 而获得ParquetAvroWriterFactory的方式是，利用一个工具类：ParquetAvroWriters
         ...
         * 传入这些参数，有何用？ 这个工具ParquetAvroWriters. 需要你提供你的数据模式schema（你要生成的parquet文件中数据模式schema）
