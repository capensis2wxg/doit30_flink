...
public class _21_Window_Api_Demo3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OutputTag<Tuple2<EventBean2,Integer>> lateDataOutputTag = new OutputTag<>("later_data", TypeInformation.of(new TypeHint<Tuple2<EventBean2, Integer>>() {}));
        ...
        SingleOutputStreamOperator<String> sumResult = beanStream.keyBy(tp -> tp.f0.getGuid())
                ...
                /*
                 * 允许迟到2s的含义是:
                 *      水位线到达窗口截止时间+2s的时间才关闭窗口。
                 *      换言之，在等待2s的时间让数据过来,如果数据携带的时间戳>窗口截止时间+2s, 则会关闭窗口进行计算
                 */
