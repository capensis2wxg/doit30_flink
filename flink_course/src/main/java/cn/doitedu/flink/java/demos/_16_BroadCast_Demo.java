...
public class _16_BroadCast_Demo {
    public static void main(String[] args) throws Exception {
        ...
        // id,age,city
        DataStreamSource<String> stream2 = env.socketTextStream("master102", 9999);
         ...
         */
        @SuppressWarnings("JavaDoc") SingleOutputStreamOperator<String> resultStream = connected.process(new BroadcastProcessFunction<Tuple2<String, String>, Tuple3<String, String, String>, String>() {
            /*BroadcastState<String, Tuple2<String, String>> broadcastState;*/
            /**
             * 本方法，是用来处理主流中的数据（每来一条，调用一次）
