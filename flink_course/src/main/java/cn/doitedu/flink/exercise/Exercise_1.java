...
public class Exercise_1 {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<EventCount> flattend = s1.process(new ProcessFunction<EventCount, EventCount>() {
            @Override
            public void processElement(EventCount value, ProcessFunction<EventCount, EventCount>.Context ctx, Collector<EventCount> out) {
                // 取出count值
        ...
        // 3. 利用生成好的parquetWriter，来构造一个支持列式输出parquet文件的sink算子
