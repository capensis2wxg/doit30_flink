...
*/
        ...
        consumer.assign(Collections.singletonList(new TopicPartition("ddd", 0)));
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                System.out.printf("数据key: %s , 数据value：%s ,数据所属的topic: %s ,数据所属的partition： %d, 数据的offset: %d , 数据所属leader的纪元： %s , 数据的时间戳类型: %s , 数据的时间戳： %d %n",
